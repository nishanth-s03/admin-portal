...
func (c *authServiceClient) Activate(ctx context.Context, in *ActivateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedAuthServiceServer) Activate(context.Context, *ActivateRequest) (*emptypb.Empty, error) {
